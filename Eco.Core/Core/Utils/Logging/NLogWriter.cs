...
// Type: Eco.Core.Utils.Logging.NLogWriter
...
public class NLogWriter : ILogWriter
{
  ...
  public void WriteError(string message, Exception ex, bool stripTagsForConsole = false);

  public void WriteError(Exception ex, bool stripTagsForConsole = false);
