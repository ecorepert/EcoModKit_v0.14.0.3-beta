...
// Type: Eco.Core.Properties.ThreadSafeActionSubscription`3
...
public class ThreadSafeActionSubscription<T1, T2, T3> : ISubscription
{
  public WeakReference<ThreadSafeAction<T1, T2, T3>> Target;
  public Action<T1, T2, T3> Callback;

  public ThreadSafeActionSubscription(
    ThreadSafeAction<T1, T2, T3> target,
