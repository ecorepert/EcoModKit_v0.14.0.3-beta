...
// Type: Eco.Core.Properties.ThreadSafeActionSubscription`4
...
public class ThreadSafeActionSubscription<T1, T2, T3, T4> : ISubscription
{
  public WeakReference<ThreadSafeAction<T1, T2, T3, T4>> Target;
  public Action<T1, T2, T3, T4> Callback;

  public ThreadSafeActionSubscription(
    ThreadSafeAction<T1, T2, T3, T4> target,
