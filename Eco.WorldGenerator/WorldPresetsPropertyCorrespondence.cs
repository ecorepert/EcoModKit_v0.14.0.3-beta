...
// Type: Eco.WorldGenerator.WorldPresetsPropertyCorrespondence
...
public abstract class WorldPresetsPropertyCorrespondence : Attribute
{
  public abstract object PresetValue(WorldDimensions.WorldDimensionsPreset preset);
}
