...
// Type: Eco.WorldGenerator.BiomeExtensions
...
{
  public static bool IsOcean(this Biome biome);

  public static bool IsLand(this Biome biome);

  public static bool IsGrassland(this Biome biome);

  public static bool IsDesert(this Biome biome);

  public static bool CanSpawnLake(this Biome biome);
}
