...
// Type: Eco.WorldGenerator.SpecialFeatureGenerator
...
public class SpecialFeatureGenerator
{
  public SpecialFeatureGenerator(WorldSettings settings);

  public void Generate(Action<float> updateAction);
}
