...
// Type: Eco.Mods.TechTree.MoonJellyfish
...
/// <summary>
/// <para>Server side animal entity definition for "MoonJellyfish".</para>
...
{
  public MoonJellyfish(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "MoonJellyfish".</para>
  ...
  /// </summary>
  /// <inheritdoc />
  [Ecopedia("Animals", "Invertebrates", true, true, null)]
