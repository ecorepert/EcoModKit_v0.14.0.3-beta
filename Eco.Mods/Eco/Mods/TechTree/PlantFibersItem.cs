...
// Type: Eco.Mods.TechTree.PlantFibersItem
...
[Eco.Gameplay.Items.Fuel(100f)]
[Tag("Fuel")]
[Eco.Gameplay.Items.Yield(typeof (PlantFibersItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (BioResidue), 0.1f})]
[Tag("NaturalFiber")]
[Tag("Burnable Fuel")]
[Tag("Crop")]
[LocDescription("Harvested from a number of plants, these fibers are useful for a surprising number of things.")]
public class PlantFibersItem : Item
{
}
