...
/// <summary>
/// <para>Server side animal entity definition for "Tuna".</para>
...
{
  public Tuna(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Tuna".</para>
