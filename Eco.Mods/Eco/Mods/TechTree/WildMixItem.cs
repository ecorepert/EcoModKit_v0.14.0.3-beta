...
// Type: Eco.Mods.TechTree.WildMixItem
...
[SalvageCost(new object[] {typeof (FoodScrap), 1.5f})]
[LocDescription("A dressed salad that, with the added sweetness, it's pretty tasty.")]
public class WildMixItem : FoodItem
{
