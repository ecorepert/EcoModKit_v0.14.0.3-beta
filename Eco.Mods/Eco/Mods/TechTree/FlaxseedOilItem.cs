...
// Type: Eco.Mods.TechTree.FlaxseedOilItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Flaxseed Oil")]
[Eco.Gameplay.Items.Weight(100)]
[Eco.Gameplay.Items.Fuel(4000f)]
[Tag("Fuel")]
[Tag("Fat")]
[Tag("Oil")]
[Ecopedia("Food", "Ingredients", true, true, null)]
[SalvageCost(new object[] {typeof (FoodScrap), 0.5f})]
[LocDescription("An oil primarily used for woodworking and paint supplies but can surprisingly also be drizzled on a salad.")]
public class FlaxseedOilItem : FoodItem
{
