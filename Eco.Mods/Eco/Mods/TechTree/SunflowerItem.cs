...
// Type: Eco.Mods.TechTree.SunflowerItem
...
[Eco.Gameplay.Items.Yield(typeof (SunflowerItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Crop]
[Tag("Crop")]
[Tag("Harvestable")]
[Ecopedia("Food", "Produce", true, true, null)]
[SalvageCost(new object[] {typeof (FoodScrap), 0.05f})]
[LocDescription("A plant whose seeds are quite versitile in their use further processed.")]
public class SunflowerItem : FoodItem
{
