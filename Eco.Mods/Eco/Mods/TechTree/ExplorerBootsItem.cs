...
// Type: Eco.Mods.TechTree.ExplorerBootsItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Explorer Boots")]
[LocDescription("Boots with rubber soles and thermal insulation for comfort while staying durable.")]
[Eco.Gameplay.Items.Weight(100)]
[SalvageCost(new object[] {typeof (Textiles), 0.3f, typeof (ChemicalWaste), 0.4f})]
[Tag("Clothes")]
[Ecopedia("Items", "Clothing", true, true, null)]
public class ExplorerBootsItem : ClothingItem
{
