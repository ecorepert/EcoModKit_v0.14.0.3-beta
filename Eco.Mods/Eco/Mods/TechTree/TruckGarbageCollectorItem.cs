...
// Type: Eco.Mods.TechTree.TruckGarbageCollectorItem
...
/// <summary>
/// <para>Server side item definition for the "TruckGarbageCollector" item.</para>
...
/// </remarks>
[Serialized]
[LocDisplayName("Truck Garbage Collector")]
...
[SalvageCost(new object[] {typeof (IronScrap), 6f, typeof (CopperScrap), 0.6f, typeof (ChemicalWaste), 0.2f, typeof (GlassScrap), 0.1f})]
[Tag("Tool")]
[LocDescription("A garbage compaction module for the modern truck.")]
public class TruckGarbageCollectorItem : VehicleToolItem
{
