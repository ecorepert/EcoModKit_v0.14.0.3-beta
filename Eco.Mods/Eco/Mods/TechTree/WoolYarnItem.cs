...
// Type: Eco.Mods.TechTree.WoolYarnItem
...
[SalvageCost(new object[] {typeof (Textiles), 0.5f})]
[LocDescription("Spun wool that can be used for knitting, weaving, or sewing.")]
public class WoolYarnItem : Item
{
