...
// Type: Eco.Mods.TechTree.HeartOfPalmItem
...
[Eco.Gameplay.Items.Weight(150)]
[Eco.Gameplay.Items.Yield(typeof (HeartOfPalmItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Crop]
[Tag("Crop")]
[Tag("Harvestable")]
[Tag("Vegetable")]
...
[LocDescription("Collected from the inner core and growing bud of a palm tree.")]
public class HeartOfPalmItem : FoodItem
{
