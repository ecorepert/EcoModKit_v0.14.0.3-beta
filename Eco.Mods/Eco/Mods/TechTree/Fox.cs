...
/// <summary>
/// <para>Server side animal entity definition for "Fox".</para>
...
{
  public Fox(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Fox".</para>
