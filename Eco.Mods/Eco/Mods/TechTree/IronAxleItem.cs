...
// Type: Eco.Mods.TechTree.IronAxleItem
...
[LocDescription("A rotating iron rod that can be fixed to wheels for use in vehicles.")]
public class IronAxleItem : PartItem
{
