...
// Type: Eco.Mods.TechTree.GarbageSorterItem
...
[Serialized]
[LocDisplayName("Garbage Sorter")]
[LocDescription("A mechanical sorting system that processes mixed garbage and separates it into primary recycling types. Materials are categorized according to the fractioanl composition of the incoming waste, producing Mixed blocks of varies types, Bio Residue, Metal Scrap, Construction Scrap and Industrial Waste.")]
...
public class GarbageSorterItem : WorldObjectItem<GarbageSorterObject>, IPersistentData
{
