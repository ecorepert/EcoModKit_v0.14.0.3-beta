...
// Type: Eco.Mods.TechTree.SteelBinObject
...
/// <summary>Hand-written half of the Tech Tree-generated <see cref="T:Eco.Mods.TechTree.SteelBinObject" />: promotes the steel bin into a garbage bin a truck garbage module can drain.
/// Metal counterpart to the Modern (plastic) bins — used to test the Steam Truck garbage module, since the Modern bins aren't available at the Steam Truck's tier.
...
[Tag("Usable")]
[Ecopedia("Waste Management", "Containment", false, true, "Steel Bin Item")]
public class SteelBinObject : WorldObject, IRepresentsItem, IGarbageBin
{
