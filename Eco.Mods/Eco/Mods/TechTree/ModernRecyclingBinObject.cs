...
// Type: Eco.Mods.TechTree.ModernRecyclingBinObject
...
/// <summary>Hand-written half of the Tech Tree-generated <see cref="T:Eco.Mods.TechTree.ModernRecyclingBinObject" />: implements <see cref="T:Eco.Mods.TechTree.IGarbageBin" /> so a parked truck garbage
/// module can drain it, and restricts its storage to garbage-tagged items (the codebase's unifying waste tag — see CompostItem and Waste.cs).
...
[Tag("Usable")]
[Ecopedia("Waste Management", "Containment", false, true, "Modern Recycling Bin Item")]
public class ModernRecyclingBinObject : WorldObject, IRepresentsItem, IGarbageBin
{
