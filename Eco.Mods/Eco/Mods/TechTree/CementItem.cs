...
// Type: Eco.Mods.TechTree.CementItem
...
[SalvageCost(new object[] {typeof (CeramicScrap), 0.1f, typeof (StoneRubble), 0.05f})]
[LocDescription("In order to be usable it needs to be reinforced.")]
public class CementItem : Item
{
