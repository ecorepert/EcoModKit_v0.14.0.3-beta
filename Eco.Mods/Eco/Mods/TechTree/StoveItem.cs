...
// Type: Eco.Mods.TechTree.StoveItem
...
[SalvageCost(new object[] {typeof (CopperScrap), 0.4f, typeof (GoldScrap), 0.4f, typeof (IronScrap), 30f})]
[IgnorePowerModules]
[AllowPluginModules(ItemTypes = new Type[] {typeof (AdvancedCookingUpgradeItem), typeof (AdvancedBakingUpgradeItem), typeof (BasicUpgradeItem), typeof (AdvancedUpgradeItem), typeof (ModernUpgradeItem)})]
public class StoveItem : WorldObjectItem<StoveObject>, IPersistentData
{
