...
// Type: Eco.Mods.TechTree.MetalRudderItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Metal Rudder")]
[Eco.Gameplay.Items.Weight(2000)]
[RepairRequiresSkill(typeof (ShipwrightSkill), 0)]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (IronScrap), 8f})]
[LocDescription("If you dont have one of these, you have no control over your heading.")]
public class MetalRudderItem : PartItem
{
  public override 
  #nullable disable
