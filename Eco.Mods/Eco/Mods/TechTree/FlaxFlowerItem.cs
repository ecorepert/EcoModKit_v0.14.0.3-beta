...
// Type: Eco.Mods.TechTree.FlaxFlowerItem
...
/// <summary>
/// <para>
/// Server side food item definition for the "FlaxFlower" item.
...
/// </remarks>
[Serialized]
[LocDisplayName("Flax Flower")]
[Eco.Gameplay.Items.Weight(50)]
[Eco.Gameplay.Items.Yield(typeof (FlaxFlowerItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Crop]
[Tag("Crop")]
[Tag("Harvestable")]
[Tag("Petals")]
...
[LocDescription("Placeholder Description.")]
public class FlaxFlowerItem : FoodItem
{
