...
// Type: Eco.Mods.TechTree.BoiledGrainsItem
...
[LocDescription("A dish of plain boiled grains that can be topped with fruit to make a nice tasting porridge.")]
public class BoiledGrainsItem : FoodItem
{
