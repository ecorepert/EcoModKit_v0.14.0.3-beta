...
// Type: Eco.Mods.TechTree.RadiatorItem
...
[SalvageCost(new object[] {typeof (CopperScrap), 3f})]
[LocDescription("A heat sink that uses liquid running through copper fins to disperse heat build-up.")]
public class RadiatorItem : PartItem
{
