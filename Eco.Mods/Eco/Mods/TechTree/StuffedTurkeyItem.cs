...
// Type: Eco.Mods.TechTree.StuffedTurkeyItem
...
[LocDescription("To give thanks for the fact that this food gives two extra nutrients than other food items of the same tier.")]
public class StuffedTurkeyItem : FoodItem
{
