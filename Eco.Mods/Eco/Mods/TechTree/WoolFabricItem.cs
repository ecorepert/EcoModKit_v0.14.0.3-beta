...
// Type: Eco.Mods.TechTree.WoolFabricItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Wool Fabric")]
[Eco.Gameplay.Items.Weight(100)]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (Textiles), 1f})]
[Tag("Fabric")]
[LocDescription("Wool fabric is warm and durable, but it can be slightly itchy.")]
public class WoolFabricItem : Item
{
