...
// Type: Eco.Mods.TechTree.KelpItem
...
[Eco.Gameplay.Items.Yield(typeof (KelpItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (FoodScrap), 0.1f})]
[Tag("NaturalFiber")]
[Tag("Crop")]
[LocDescription("Some creepy kelp.")]
