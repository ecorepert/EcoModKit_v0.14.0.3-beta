...
// Type: Eco.Mods.TechTree.CameraFilmItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Camera Film")]
[Eco.Gameplay.Items.Weight(100)]
[RelatedFeature("CameraModeEnabled", true)]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (BioResidue), 0.2f, typeof (GlassScrap), 0.1f, typeof (CopperScrap), 0.1f})]
[LocDescription("A film used inside a camera.")]
public class CameraFilmItem : Item
{
}
