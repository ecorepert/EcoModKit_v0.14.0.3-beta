...
// Type: Eco.Mods.TechTree.SteelAxleItem
...
[SalvageCost(new object[] {typeof (IronScrap), 2f, typeof (PlasticScrap), 0.1f})]
[LocDescription("A rotating steel rod that can be fixed to wheels for use in vehicles.")]
public class SteelAxleItem : PartItem
{
