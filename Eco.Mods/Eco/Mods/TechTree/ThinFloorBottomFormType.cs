...
// Type: Eco.Mods.TechTree.ThinFloorBottomFormType
...
/// <summary>
/// <para>Server side definition for the "ThinFloorBottom" form type. </para>
...
/// </remarks>
public class ThinFloorBottomFormType : 
  FormType,
  IWaterLoggedBlock,
  IExtraBlockData,
  IColoredBlock,
  IColorBlockData
{
  ...
  public override bool IsBottomHalfFill { get; }
}
