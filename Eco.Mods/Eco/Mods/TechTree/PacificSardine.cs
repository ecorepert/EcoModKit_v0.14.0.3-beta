...
// Type: Eco.Mods.TechTree.PacificSardine
...
/// <summary>
/// <para>Server side animal entity definition for "PacificSardine".</para>
...
{
  public PacificSardine(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "PacificSardine".</para>
