...
// Type: Eco.Mods.TechTree.SensorBasedBeltSorterItem
...
[SalvageCost(new object[] {typeof (CopperScrap), 2.8f, typeof (ElectronicScrap), 1f, typeof (GoldScrap), 3.5f, typeof (IronScrap), 44.2f, typeof (PlasticScrap), 1f})]
[IgnorePowerModules]
[AllowPluginModules(ItemTypes = new Type[] {typeof (MiningModernUpgradeItem), typeof (ModernUpgradeItem)})]
public class SensorBasedBeltSorterItem : 
