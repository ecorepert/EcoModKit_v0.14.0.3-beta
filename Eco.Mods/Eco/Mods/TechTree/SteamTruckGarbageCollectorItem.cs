...
// Type: Eco.Mods.TechTree.SteamTruckGarbageCollectorItem
...
/// <summary>
/// <para>Server side item definition for the "SteamTruckGarbageCollector" item.</para>
...
/// </remarks>
[Serialized]
[LocDisplayName("Steam Truck Garbage Collector")]
...
[SalvageCost(new object[] {typeof (IronScrap), 3f})]
[Tag("Tool")]
[LocDescription("A garbage compaction module for the steam truck.")]
public class SteamTruckGarbageCollectorItem : VehicleToolItem
{
  ...
  public override int AddedSeats { get; }
