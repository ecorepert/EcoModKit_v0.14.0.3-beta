...
// Type: Eco.Mods.TechTree.SteamTractorItem
...
[SalvageCost(new object[] {typeof (BioResidue), 0.8f, typeof (IronScrap), 16f, typeof (Textiles), 1.2f, typeof (CopperScrap), 4f, typeof (ChemicalWaste), 2f})]
[Tag("Excavation")]
[AirPollution(0.05f)]
[Ecopedia("Crafted Objects", "Vehicles", true, true, null)]
public class SteamTractorItem : WorldObjectItem<SteamTractorObject>, IPersistentData
{
  [Serialized]
