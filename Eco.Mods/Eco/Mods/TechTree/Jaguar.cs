...
/// <summary>
/// <para>Server side animal entity definition for "Jaguar".</para>
...
{
  public Jaguar(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Jaguar".</para>
  ...
  /// </summary>
  /// <inheritdoc />
  [Ecopedia("Animals", "Mammals", true, true, null)]
