...
// Type: Eco.Mods.TechTree.Tortoise
...
/// <summary>
/// <para>Server side animal entity definition for "Tortoise".</para>
...
{
  public Tortoise(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Tortoise".</para>
