...
// Type: Eco.Mods.TechTree.RollingMillItem
...
[SalvageCost(new object[] {typeof (BioResidue), 0.4f, typeof (IronScrap), 8f})]
[IgnorePowerModules]
[AllowPluginModules(ItemTypes = new Type[] {typeof (AdvancedSmeltingUpgradeItem), typeof (BasicUpgradeItem), typeof (AdvancedUpgradeItem), typeof (ModernUpgradeItem)})]
public class RollingMillItem : WorldObjectItem<RollingMillObject>, IPersistentData
{
