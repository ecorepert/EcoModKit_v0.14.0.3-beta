...
// Type: Eco.Mods.TechTree.ResidualWasteSorterObject
...
/// <summary>Splits MixedResidualsItem back into every pure residual: Compost, BioResidue, Garbage, Tailings, WetTailings and ChemicalPollutant.
/// No catalysts, lossless (efficiency 1), so it produces no residuals of its own — it's the terminal stage of the residuals chain.</summary>
[Serialized]
...
[Tag("Usable")]
[Ecopedia("Waste Management", "Garbage Sorting", false, true, "Residual Waste Sorter Item")]
...
public class ResidualWasteSorterObject : WorldObject, IRepresentsItem, ICatalystUser
{
