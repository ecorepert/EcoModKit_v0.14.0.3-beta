...
// Type: Eco.Mods.TechTree.Alligator
...
/// <summary>
/// <para>Server side animal entity definition for "Alligator".</para>
...
{
  public Alligator(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Alligator".</para>
  ...
  /// </summary>
  /// <inheritdoc />
  [Ecopedia("Animals", "Reptiles", true, true, null)]
