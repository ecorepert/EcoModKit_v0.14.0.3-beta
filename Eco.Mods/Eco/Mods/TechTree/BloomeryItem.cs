...
// Type: Eco.Mods.TechTree.BloomeryItem
...
[SalvageCost(new object[] {typeof (CeramicScrap), 5f, typeof (StoneRubble), 8.4f})]
[IgnorePowerModules]
[AllowPluginModules(ItemTypes = new Type[] {typeof (SmeltingUpgradeItem), typeof (BasicUpgradeItem), typeof (AdvancedUpgradeItem), typeof (ModernUpgradeItem)})]
public class BloomeryItem : ModuleItem<BloomeryObject>, IPersistentData
{
