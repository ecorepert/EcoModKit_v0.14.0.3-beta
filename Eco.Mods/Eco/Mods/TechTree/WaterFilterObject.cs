...
// Type: Eco.Mods.TechTree.WaterFilterObject
...
/// <summary>Coal-burning filter that purifies polluted water (fresh or salt) and drops captured organic pollutants as MixedGarbageBlocks.</summary>
[Serialized]
...
[Tag("Usable")]
[Ecopedia("Waste Management", "Treatment", false, true, "Water Filter Item")]
[RequireComponent(typeof (AttachmentComponent), null)]
[RequireComponent(typeof (FilterComponent), null)]
public class WaterFilterObject : WorldObject, IRepresentsItem, ICatalystUser
{
