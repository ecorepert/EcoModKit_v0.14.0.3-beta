...
/// <summary>
/// <para>Server side animal entity definition for "Trout".</para>
...
{
  public Trout(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Trout".</para>
