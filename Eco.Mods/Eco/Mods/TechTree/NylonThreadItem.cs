...
// Type: Eco.Mods.TechTree.NylonThreadItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Nylon Thread")]
[Eco.Gameplay.Items.Weight(25)]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (ChemicalWaste), 0.1f})]
[LocDescription("Synthetic thread that has more resistance to abrasion than more natural threads.")]
public class NylonThreadItem : PartItem, IRepairMaterial
{
