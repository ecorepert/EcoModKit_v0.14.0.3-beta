...
// Type: Eco.Mods.TechTree.GlassInsulationItem
...
/// <summary>
/// <para>Server side item definition for the "GlassInsulation" item.</para>
...
/// </remarks>
[Serialized]
[LocDisplayName("Glass Insulation")]
[Eco.Gameplay.Items.Weight(300)]
[System.ComponentModel.Category("Hidden")]
[NoIcon]
[SalvageCost(new object[] {typeof (GlassScrap), 0.1f})]
[Tag("Insulation")]
[LocDescription("Glass wool is an insulation material made from recycled glass and sand that are melted and formed into fine fibers.")]
public class GlassInsulationItem : Item
{
}
