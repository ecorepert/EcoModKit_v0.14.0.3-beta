...
// Type: Eco.Mods.TechTree.BlueShark
...
/// <summary>
/// <para>Server side animal entity definition for "BlueShark".</para>
...
{
  public BlueShark(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "BlueShark".</para>
