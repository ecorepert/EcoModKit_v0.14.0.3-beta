...
// Type: Eco.Mods.TechTree.ThinWallStraightFormType
...
/// <summary>
/// <para>Server side definition for the "ThinWallStraight" form type. </para>
...
/// </remarks>
public class ThinWallStraightFormType : 
  FormType,
  IWaterLoggedBlock,
  IExtraBlockData,
  IColoredBlock,
  IColorBlockData
{
  ...
  public override bool IsSideFill { get; }
}
