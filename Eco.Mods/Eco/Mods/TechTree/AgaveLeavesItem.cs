...
// Type: Eco.Mods.TechTree.AgaveLeavesItem
...
[Eco.Gameplay.Items.Yield(typeof (AgaveLeavesItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Crop]
[Tag("Crop")]
[Tag("Harvestable")]
[Tag("Greens")]
...
[LocDescription("The succulent leaves of the agave plant can be cooked to make a nice meal.")]
public class AgaveLeavesItem : FoodItem
{
