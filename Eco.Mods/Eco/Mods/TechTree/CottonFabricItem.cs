...
// Type: Eco.Mods.TechTree.CottonFabricItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Cotton Fabric")]
[Eco.Gameplay.Items.Weight(100)]
[Tag("Currency")]
[Currency(10000)]
[Ecopedia("Items", "Products", true, true, null)]
[SalvageCost(new object[] {typeof (Textiles), 0.2f})]
[Tag("Fabric")]
[LocDescription("Cotton fabric is valued for its light weight, breathability, and softness.")]
public class CottonFabricItem : PartItem
{
