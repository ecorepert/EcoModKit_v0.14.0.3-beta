...
/// <summary>
/// <para>Server side animal entity definition for "Crab".</para>
...
{
  public Crab(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Crab".</para>
