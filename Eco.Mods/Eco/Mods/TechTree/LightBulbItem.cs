...
// Type: Eco.Mods.TechTree.LightBulbItem
...
[SalvageCost(new object[] {typeof (GlassScrap), 1f, typeof (CopperScrap), 0.5f})]
[LocDescription("An electric light with a wire filament.")]
public class LightBulbItem : PartItem
{
