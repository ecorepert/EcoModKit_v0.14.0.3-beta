...
// Type: Eco.Mods.TechTree.BuilderBootsItem
...
/// </remarks>
[Serialized]
[LocDisplayName("Builder Boots")]
[LocDescription("Snug work boots with side zippers.")]
[Eco.Gameplay.Items.Weight(100)]
[SalvageCost(new object[] {typeof (BioResidue), 0.2f, typeof (IronScrap), 0.2f, typeof (ChemicalWaste), 0.4f})]
[Tag("Clothes")]
[Ecopedia("Items", "Clothing", true, true, null)]
public class BuilderBootsItem : ClothingItem
{
