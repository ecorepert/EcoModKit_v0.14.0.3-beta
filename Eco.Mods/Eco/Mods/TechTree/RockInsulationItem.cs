...
// Type: Eco.Mods.TechTree.RockInsulationItem
...
/// <summary>
/// <para>Server side item definition for the "RockInsulation" item.</para>
...
/// </remarks>
[Serialized]
[LocDisplayName("Rock Insulation")]
[Eco.Gameplay.Items.Weight(300)]
[System.ComponentModel.Category("Hidden")]
[NoIcon]
[SalvageCost(new object[] {typeof (StoneRubble), 0.1f})]
[Tag("Insulation")]
[LocDescription("Rock wool is a mineral-based insulation made by melting natural rock and spinning it into dense fibers.")]
public class RockInsulationItem : Item
{
}
