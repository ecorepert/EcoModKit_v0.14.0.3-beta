...
// Type: Eco.Mods.TechTree.BeetGreensItem
...
[Eco.Gameplay.Items.Yield(typeof (BeetGreensItem), typeof (GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2f})]
[Crop]
[Tag("Crop")]
[Tag("Harvestable")]
[Tag("Greens")]
...
[LocDescription("The leafy greens from a beet with a distinctive red stem.")]
public class BeetGreensItem : FoodItem
{
