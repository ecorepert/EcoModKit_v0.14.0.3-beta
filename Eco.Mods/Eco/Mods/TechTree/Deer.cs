...
/// <summary>
/// <para>Server side animal entity definition for "Deer".</para>
...
{
  public Deer(Animal parent, Vector3 pos, bool corpse, bool sick, int herdId);

  /// <summary>
  /// <para>Server side species definition for "Deer".</para>
