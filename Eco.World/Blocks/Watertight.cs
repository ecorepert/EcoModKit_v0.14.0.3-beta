...
// Type: Eco.World.Blocks.Watertight
...
/// <summary>
/// Attribute used to mark a block that, if water is surrounded by a lower aqueduct material
/// and two side aqueducts, it will flow without loss.
/// </summary>
public sealed class Watertight : BlockAttribute
{
}
