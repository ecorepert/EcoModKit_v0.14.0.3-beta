...
// Type: Eco.World.Blocks.GroundPollutionType
...
/// <summary>Discriminator on <see cref="T:Eco.World.Blocks.PolluteGround" /> selecting which buffer pollution layer the block feeds into.</summary>
[Serialized]
public enum GroundPollutionType
{
  None,
  Soil,
  HeavyMineral,
