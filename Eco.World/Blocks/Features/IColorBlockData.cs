...
// Type: Eco.World.Blocks.Features.IColorBlockData
...
#nullable disable
namespace Eco.World.Blocks.Features;

public interface IColorBlockData
{
  /// <summary>Returns the current dye color of this block instance.</summary>
  ByteColor GetColor(Vector3i worldPosition);
}
