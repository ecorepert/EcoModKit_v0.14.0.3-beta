...
// Type: Eco.World.Blocks.DoesntEncase
...
/// <summary>Attribute used to signify a block that doesn't encase chunks.</summary>
public sealed class DoesntEncase : BlockAttribute
{
}
