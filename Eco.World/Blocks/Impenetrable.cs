...
// Type: Eco.World.Blocks.Impenetrable
...
/// <summary>Attribute used to mark a block that cannot be removed by players.</summary>
public sealed class Impenetrable : BlockAttribute
{
}
