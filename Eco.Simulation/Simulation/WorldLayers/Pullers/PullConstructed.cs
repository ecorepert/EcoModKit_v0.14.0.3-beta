...
// Type: Eco.Simulation.WorldLayers.Pullers.PullConstructed
...
public class PullConstructed : WorldLayerPuller<float>
{
  public override string OutputLayerName { get; }

  public PullConstructed(string outputLayerName, bool underwater = false);
