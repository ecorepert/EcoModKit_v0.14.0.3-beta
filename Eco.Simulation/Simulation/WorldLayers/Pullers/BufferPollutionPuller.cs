...
// Type: Eco.Simulation.WorldLayers.Pullers.BufferPollutionPuller
...
public class BufferPollutionPuller : WorldLayerPuller<float>
{
  public GroundPollutionType Type { get; }

  public BufferPollutionPuller(
    GroundPollutionType type,
    string outputLayerName,
    string pendingLayerName);
