...
// Type: Eco.ModKit.Internal.Cecil.AssemblyReferenceConverter
...
internal readonly struct AssemblyReferenceConverter
{
  private readonly MetadataReader reader;

  public AssemblyReferenceConverter(MetadataReader reader);

  /// <summary>Converts <paramref name="handle" /> to <see cref="T:Mono.Cecil.AssemblyNameReference" />.</summary>
  public AssemblyNameReference Convert(AssemblyReferenceHandle handle);
}
