...
// Type: Eco.Server.UI.Controls.EcoToolStripMenuItem
...
internal class EcoToolStripMenuItem : ToolStripMenuItem
{
  public string LocalizedText { get; set; }

  public EcoToolStripMenuItem(string name);

  public EcoToolStripMenuItem();
}
