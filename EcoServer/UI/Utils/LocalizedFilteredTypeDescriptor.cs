...
// Type: Eco.Server.UI.Utils.LocalizedFilteredTypeDescriptor
...
public class LocalizedFilteredTypeDescriptor : CustomTypeDescriptor
{
  public LocalizedFilteredTypeDescriptor(object o);
