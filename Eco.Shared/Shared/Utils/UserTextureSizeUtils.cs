...
// Type: Eco.Shared.Utils.UserTextureSizeUtils
...
public static class UserTextureSizeUtils
{
  ...
  public static bool TryGetUserTextureFromString(string tagValue, out UserTextureSize result);
}
