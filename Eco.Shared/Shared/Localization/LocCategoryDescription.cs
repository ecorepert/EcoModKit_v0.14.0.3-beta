...
// Type: Eco.Shared.Localization.LocCategoryDescription
...
public class LocCategoryDescription : DescriptionAttribute
{
  ...
  public LocCategoryDescription(string description);
}
