...
// Type: Eco.Gameplay.Property.RequireRoomVolumeAttribute
...
public class RequireRoomVolumeAttribute : RoomRequirementAttribute
{
  public readonly int Volume;

  public RequireRoomVolumeAttribute(int volume);
