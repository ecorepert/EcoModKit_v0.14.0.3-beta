...
// Type: Eco.Gameplay.Systems.Messaging.Mail.Mailbox
...
[Serialized]
public class Mailbox : IController, IViewController, IHasUniversalID
{
  [Serialized]
  ...
  public bool HasMailWithCommonId(string commonId);
