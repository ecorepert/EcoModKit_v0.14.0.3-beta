...
// Type: Eco.Gameplay.Civics.GameValues.Values.IsGovernmentAccount
...
[LocDescription("Queries if a given bank account is a government account.")]
public class IsGovernmentAccount : GameValue<bool>
{
  [Eco.Shared.Networking.Eco(true)]
