...
[LocDescription("Requirements regarding property rights.")]
[NoAutogenCode]
[RequiredContext(new Type[] {typeof (IPositionGameAction)})]
public class PropertyRequirements : LocationTest
{
  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("The citizen or group to test.")]
  [Advanced]
  public GameValue<IAlias> Citizen { get; set; }

  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("Should they be authorized or unauthorized?")]
  public Authorization AuthorizedOrNot { get; set; }
