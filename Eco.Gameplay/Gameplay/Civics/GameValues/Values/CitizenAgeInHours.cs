...
[LocDescription("Number of hours since the citizen's first login.")]
[CanAutoAssign]
public class CitizenAgeInHours : GameValue<float>
{
  public override LocString Description();

  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("The citizen whose age we're testing.")]
  [CanAutoAssign]
