...
[LocDescription("Detect if a citizen is a member in a set of demographics.")]
[NoAutogenCode]
public class MatchesDemographic : MembershipRequirements
{
  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("Which demographics to check.")]
