...
// Type: Eco.Gameplay.Civics.GameValues.Values.PopulationAtDistrict
...
[LocDescription("Population values relative to districts.")]
public class PopulationAtDistrict : PopulationGameValue<float>
{
  [Eco.Shared.Networking.Eco(true)]
