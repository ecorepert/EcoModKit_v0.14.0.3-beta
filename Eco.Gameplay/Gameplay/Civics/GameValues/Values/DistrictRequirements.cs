...
[LocDescription("Test if a given location is within a set of districts.")]
[NoAutogenCode]
public class DistrictRequirements : 
  DistrictGameValue<bool>,
...
{
  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("Location to check district status of.")]
  [Advanced]
