...
// Type: Eco.Gameplay.Settlements.SettlementConfigExtensions
...
public static class SettlementConfigExtensions
{
  ...
  public static float CalcBaseInfluence(this SettlementType type);
