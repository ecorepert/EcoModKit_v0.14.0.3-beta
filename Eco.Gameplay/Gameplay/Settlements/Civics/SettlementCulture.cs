...
// Type: Eco.Gameplay.Settlements.Civics.SettlementCulture
...
[LocDescription("The culture value of the given settlement.")]
[RelatedFeature("UseSettlementSystem", true)]
public class SettlementCulture : SettlementProperty<float>
{
