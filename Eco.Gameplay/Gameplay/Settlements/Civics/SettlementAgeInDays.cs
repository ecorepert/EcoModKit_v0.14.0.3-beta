...
// Type: Eco.Gameplay.Settlements.Civics.SettlementAgeInDays
...
[LocDescription("Returns the age of the given settlement.")]
[RelatedFeature("UseSettlementSystem", true)]
public class SettlementAgeInDays : SettlementProperty<float>
{
