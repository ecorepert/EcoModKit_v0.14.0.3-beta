...
// Type: Eco.Gameplay.Settlements.Civics.SettlementInfluencingPosition
...
[LocDescription("Determines the settlement of the given type influencing the given location.")]
[RelatedFeature("UseSettlementSystem", true)]
public class SettlementInfluencingPosition : GameValue<Settlement>
{
  [Eco.Shared.Networking.Eco(true)]
