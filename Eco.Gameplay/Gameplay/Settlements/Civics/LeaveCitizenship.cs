...
// Type: Eco.Gameplay.Settlements.Civics.LeaveCitizenship
...
[LocDescription("Triggered when citizenship is lost.")]
[CannotBePrevented]
public class LeaveCitizenship : 
  GameAction,
  IUserGameAction,
  IController,
  IViewController,
  IHasUniversalID
{
  ...
  [LocDescription("Is this the first time they're leaving as a citizn of this settlement (direct or indirect)?")]
  public FirstTimeOrNotFirstTime FirstTimeLeaving { get; set; }
  ...
  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("The settlement they left direct citizenship of.")]
