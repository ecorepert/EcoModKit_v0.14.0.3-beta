...
// Type: Eco.Gameplay.GameActions.SkillAction
  ...
  ISkillGameAction
{
  ...
  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("The profession of the gained specialty.")]
  [RequiredTag("Profession")]
  public Skill Profession { get; set; }

  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("The specialty gained.")]
  [CanAutoAssign]
  [RequiredTag("Specialty")]
  public Skill Specialty { get; set; }
