...
// Type: Eco.Gameplay.GameActions.GainSpecialty
...
[LocDescription("A citizen took a new specialty.")]
[ExtendedDescriptionLocStr("Triggers laws on settlements that the Citizen is a part of.")]
public class GainSpecialty : SkillAction
{
  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("Number of stars used.")]
  [CanAutoAssign]
