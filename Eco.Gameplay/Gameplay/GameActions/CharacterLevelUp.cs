...
// Type: Eco.Gameplay.GameActions.CharacterLevelUp
...
[LocDescription("A citizen leveled-up their character, gaining a new specialty to choose.")]
  ...
  IHasUniversalID
{
  ...
  [LocDescription("The citizen leveling up.")]
  [CanAutoAssign]
  public User Citizen { get; set; }

  [Eco.Shared.Networking.Eco(true)]
  [LocDescription("The citizen's new level.")]
