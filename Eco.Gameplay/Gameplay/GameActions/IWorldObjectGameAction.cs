...
// Type: Eco.Gameplay.GameActions.IWorldObjectGameAction
...
public interface IWorldObjectGameAction : IController, IViewController, IHasUniversalID
{
  ...
  /// <summary> If set to true allows to use parent object auth instead of deed when placing on other objects with overriding access to consumer </summary>
