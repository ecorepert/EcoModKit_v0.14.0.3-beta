...
// Type: Eco.Gameplay.GameActions.MoveWorldObject
...
[LocDescription("An object was moved.")]
[ExtendedDescriptionLocStr("Triggers laws on settlements influencing the start and end locations where it was performed.")]
[ChangeParentConfigLoc("ItemUsed", "World Object Moved", null, typeof (Eco.Gameplay.Items.WorldObjectItem), false)]
[ChangeParentConfigLoc("WorldObjectItem", null, null, null, true)]
public class MoveWorldObject : 
  ItemInteractAction,
  ...
  IPretestAction
{
  ...
  [LocDescription("The position of the object before it was moved.")]
  [CanAutoAssign]
