...
// Type: StrangeCloud.Service.Client.Contracts.Response15
...
public class Response15
{
  ...
  {
    return JsonConvert.DeserializeObject<Response15>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
