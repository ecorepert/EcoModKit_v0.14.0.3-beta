...
// Type: StrangeCloud.Service.Client.Contracts.Response33
...
public class Response33
{
  ...
  {
    return JsonConvert.DeserializeObject<Response33>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
