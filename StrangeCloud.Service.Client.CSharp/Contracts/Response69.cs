...
// Type: StrangeCloud.Service.Client.Contracts.Response69
...
public class Response69
{
  ...
  {
    return JsonConvert.DeserializeObject<Response69>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
