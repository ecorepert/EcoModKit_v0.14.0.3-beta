...
// Type: StrangeCloud.Service.Client.Contracts.Response49
...
public class Response49
{
  ...
  {
    return JsonConvert.DeserializeObject<Response49>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
