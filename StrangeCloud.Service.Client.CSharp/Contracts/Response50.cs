...
// Type: StrangeCloud.Service.Client.Contracts.Response50
...
public class Response50
{
  ...
  {
    return JsonConvert.DeserializeObject<Response50>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
