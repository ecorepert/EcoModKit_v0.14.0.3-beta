...
// Type: StrangeCloud.Service.Client.Contracts.UserTaxNotification
...
public class UserTaxNotification
{
  ...
  public static UserTaxNotification FromJson(string data)
  {
    return JsonConvert.DeserializeObject<UserTaxNotification>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
