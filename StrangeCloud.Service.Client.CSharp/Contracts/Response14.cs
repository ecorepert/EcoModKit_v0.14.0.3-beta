...
// Type: StrangeCloud.Service.Client.Contracts.Response14
...
public class Response14
{
  ...
  {
    return JsonConvert.DeserializeObject<Response14>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
