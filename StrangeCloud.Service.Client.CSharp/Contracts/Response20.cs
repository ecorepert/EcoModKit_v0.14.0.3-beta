...
// Type: StrangeCloud.Service.Client.Contracts.Response20
...
public class Response20
{
  ...
  {
    return JsonConvert.DeserializeObject<Response20>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
