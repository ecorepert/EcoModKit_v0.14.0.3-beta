...
// Type: StrangeCloud.Service.Client.Contracts.Response23
...
public class Response23
{
  ...
  {
    return JsonConvert.DeserializeObject<Response23>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
