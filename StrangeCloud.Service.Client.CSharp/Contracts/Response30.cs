...
// Type: StrangeCloud.Service.Client.Contracts.Response30
...
public class Response30
{
  ...
  {
    return JsonConvert.DeserializeObject<Response30>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
