...
// Type: StrangeCloud.Service.Client.Contracts.Response35
...
public class Response35
{
  ...
  {
    return JsonConvert.DeserializeObject<Response35>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
