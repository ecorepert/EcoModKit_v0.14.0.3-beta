...
// Type: StrangeCloud.Service.Client.Contracts.Response62
...
public class Response62
{
  ...
  {
    return JsonConvert.DeserializeObject<Response62>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
