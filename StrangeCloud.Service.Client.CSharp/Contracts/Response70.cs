...
// Type: StrangeCloud.Service.Client.Contracts.Response70
...
public class Response70
{
  ...
  {
    return JsonConvert.DeserializeObject<Response70>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
