...
// Type: StrangeCloud.Service.Client.Contracts.Response71
...
public class Response71
{
  ...
  {
    return JsonConvert.DeserializeObject<Response71>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
