...
// Type: StrangeCloud.Service.Client.Contracts.UsernameOrEmailAndPassword
...
public class UsernameOrEmailAndPassword
{
  ...
  public static UsernameOrEmailAndPassword FromJson(string data)
  {
    return JsonConvert.DeserializeObject<UsernameOrEmailAndPassword>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
