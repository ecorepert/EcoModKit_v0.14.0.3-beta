...
// Type: StrangeCloud.Service.Client.Contracts.VoiceTokenResult
...
/// <summary>Result for any vivox request. (StrangeCloud responce)</summary>
[GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
public class VoiceTokenResult
{
  [JsonProperty("token")]
  ...
  public static VoiceTokenResult FromJson(string data)
  {
    return JsonConvert.DeserializeObject<VoiceTokenResult>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
