...
// Type: StrangeCloud.Service.Client.Contracts.Response36
...
public class Response36
{
  ...
  {
    return JsonConvert.DeserializeObject<Response36>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
