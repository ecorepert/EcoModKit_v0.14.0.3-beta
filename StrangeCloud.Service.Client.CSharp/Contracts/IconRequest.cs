...
// Type: StrangeCloud.Service.Client.Contracts.IconRequest
...
public class IconRequest
{
  ...
  public static IconRequest FromJson(string data)
  {
    return JsonConvert.DeserializeObject<IconRequest>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
