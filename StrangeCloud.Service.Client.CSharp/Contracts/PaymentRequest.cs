...
// Type: StrangeCloud.Service.Client.Contracts.PaymentRequest
...
public class PaymentRequest
{
  ...
  public static PaymentRequest FromJson(string data)
  {
    return JsonConvert.DeserializeObject<PaymentRequest>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
