...
// Type: StrangeCloud.Service.Client.Contracts.Response25
...
public class Response25
{
  ...
  {
    return JsonConvert.DeserializeObject<Response25>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
