...
// Type: StrangeCloud.Service.Client.Contracts.Response74
...
public class Response74
{
  ...
  {
    return JsonConvert.DeserializeObject<Response74>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
