...
// Type: StrangeCloud.Service.Client.Contracts.Response73
...
public class Response73
{
  ...
  {
    return JsonConvert.DeserializeObject<Response73>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
