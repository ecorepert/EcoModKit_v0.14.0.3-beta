...
// Type: StrangeCloud.Service.Client.Contracts.Response32
...
public class Response32
{
  ...
  {
    return JsonConvert.DeserializeObject<Response32>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
