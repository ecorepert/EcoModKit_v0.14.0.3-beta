...
// Type: StrangeCloud.Service.Client.Contracts.Response67
...
public class Response67
{
  ...
  {
    return JsonConvert.DeserializeObject<Response67>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
