...
// Type: StrangeCloud.Service.Client.Contracts.Response7
...
public class Response7
{
  ...
  {
    return JsonConvert.DeserializeObject<Response7>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
