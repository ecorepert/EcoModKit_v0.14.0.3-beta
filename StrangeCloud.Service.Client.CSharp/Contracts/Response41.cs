...
// Type: StrangeCloud.Service.Client.Contracts.Response41
...
public class Response41
{
  ...
  {
    return JsonConvert.DeserializeObject<Response41>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
