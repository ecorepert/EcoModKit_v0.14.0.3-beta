...
// Type: StrangeCloud.Service.Client.Contracts.Response8
...
public class Response8
{
  ...
  {
    return JsonConvert.DeserializeObject<Response8>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
