...
// Type: StrangeCloud.Service.Client.Contracts.Response82
...
public class Response82
{
  ...
  {
    return JsonConvert.DeserializeObject<Response82>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
