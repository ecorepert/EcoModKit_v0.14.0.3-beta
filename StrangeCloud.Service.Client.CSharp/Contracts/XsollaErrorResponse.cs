...
// Type: StrangeCloud.Service.Client.Contracts.XsollaErrorResponse
...
public class XsollaErrorResponse
{
  ...
  public static XsollaErrorResponse FromJson(string data)
  {
    return JsonConvert.DeserializeObject<XsollaErrorResponse>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
