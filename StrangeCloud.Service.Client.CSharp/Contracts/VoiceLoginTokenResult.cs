...
// Type: StrangeCloud.Service.Client.Contracts.VoiceLoginTokenResult
...
/// <summary>Vivox login result, and info needed for vivox client</summary>
[GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
public class VoiceLoginTokenResult : VoiceTokenResult
{
  ...
  public static VoiceLoginTokenResult FromJson(string data)
  {
    return JsonConvert.DeserializeObject<VoiceLoginTokenResult>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
