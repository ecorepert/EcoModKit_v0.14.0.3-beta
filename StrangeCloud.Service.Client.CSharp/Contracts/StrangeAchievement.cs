...
// Type: StrangeCloud.Service.Client.Contracts.StrangeAchievement
...
public class StrangeAchievement
{
  [JsonProperty("name")]
  public string Name { get; set; }

  [JsonProperty("worldSource")]
  public Guid WorldSource { get; set; }
  ...
  public static StrangeAchievement FromJson(string data)
  {
    return JsonConvert.DeserializeObject<StrangeAchievement>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
