...
// Type: StrangeCloud.Service.Client.Contracts.Response38
...
public class Response38
{
  ...
  {
    return JsonConvert.DeserializeObject<Response38>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
