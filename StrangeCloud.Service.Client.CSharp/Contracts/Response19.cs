...
// Type: StrangeCloud.Service.Client.Contracts.Response19
...
public class Response19
{
  ...
  {
    return JsonConvert.DeserializeObject<Response19>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
