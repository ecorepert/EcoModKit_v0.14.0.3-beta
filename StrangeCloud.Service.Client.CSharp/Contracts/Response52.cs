...
// Type: StrangeCloud.Service.Client.Contracts.Response52
...
public class Response52
{
  ...
  {
    return JsonConvert.DeserializeObject<Response52>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
