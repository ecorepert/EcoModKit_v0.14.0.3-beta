...
// Type: StrangeCloud.Service.Client.Contracts.Response40
...
public class Response40
{
  ...
  {
    return JsonConvert.DeserializeObject<Response40>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
