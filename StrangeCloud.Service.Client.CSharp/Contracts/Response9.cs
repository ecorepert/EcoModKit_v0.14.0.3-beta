...
// Type: StrangeCloud.Service.Client.Contracts.Response9
...
public class Response9
{
  ...
  {
    return JsonConvert.DeserializeObject<Response9>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
