...
// Type: StrangeCloud.Service.Client.Contracts.Response66
...
public class Response66
{
  ...
  {
    return JsonConvert.DeserializeObject<Response66>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
