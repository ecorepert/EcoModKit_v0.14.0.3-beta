...
// Type: StrangeCloud.Service.Client.Contracts.Response43
...
public class Response43
{
  ...
  {
    return JsonConvert.DeserializeObject<Response43>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
