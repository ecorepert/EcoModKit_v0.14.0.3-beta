...
// Type: StrangeCloud.Service.Client.Contracts.ChangeEmailRequest
...
public class ChangeEmailRequest
{
  ...
  {
    return JsonConvert.DeserializeObject<ChangeEmailRequest>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
