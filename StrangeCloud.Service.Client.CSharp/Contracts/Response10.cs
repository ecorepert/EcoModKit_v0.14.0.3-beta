...
// Type: StrangeCloud.Service.Client.Contracts.Response10
...
public class Response10
{
  ...
  {
    return JsonConvert.DeserializeObject<Response10>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
