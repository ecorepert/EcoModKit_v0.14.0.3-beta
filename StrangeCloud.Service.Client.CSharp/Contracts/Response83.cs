...
// Type: StrangeCloud.Service.Client.Contracts.Response83
...
public class Response83
{
  ...
  {
    return JsonConvert.DeserializeObject<Response83>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
