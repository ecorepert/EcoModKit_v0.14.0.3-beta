...
// Type: StrangeCloud.Service.Client.Contracts.Response22
...
public class Response22
{
  ...
  {
    return JsonConvert.DeserializeObject<Response22>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
