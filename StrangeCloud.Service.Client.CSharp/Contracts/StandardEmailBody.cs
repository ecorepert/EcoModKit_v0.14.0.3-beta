...
// Type: StrangeCloud.Service.Client.Contracts.StandardEmailBody
...
/// <summary>A standard email template for Sendgrid.</summary>
[GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
public class StandardEmailBody
{
  [JsonProperty("title")]
  ...
  public static StandardEmailBody FromJson(string data)
  {
    return JsonConvert.DeserializeObject<StandardEmailBody>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
