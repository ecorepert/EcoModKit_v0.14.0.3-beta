...
// Type: StrangeCloud.Service.Client.Contracts.AuthenticationResult
...
public class AuthenticationResult
{
  ...
  [JsonProperty("strangeUser")]
  public StrangeUser StrangeUser { get; set; }
  ...
  public static AuthenticationResult FromJson(string data)
  {
    return JsonConvert.DeserializeObject<AuthenticationResult>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
