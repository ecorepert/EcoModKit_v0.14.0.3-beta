...
// Type: StrangeCloud.Service.Client.Contracts.Response64
...
public class Response64
{
  ...
  {
    return JsonConvert.DeserializeObject<Response64>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
