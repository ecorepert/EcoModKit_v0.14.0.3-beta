...
// Type: StrangeCloud.Service.Client.Contracts.Response80
...
public class Response80
{
  ...
  {
    return JsonConvert.DeserializeObject<Response80>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
