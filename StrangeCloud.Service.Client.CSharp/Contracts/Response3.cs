...
// Type: StrangeCloud.Service.Client.Contracts.Response3
...
public class Response3
{
  ...
  {
    return JsonConvert.DeserializeObject<Response3>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
