...
// Type: StrangeCloud.Service.Client.Contracts.AcceptDevTermsRequest
...
public class AcceptDevTermsRequest
{
  ...
  public static AcceptDevTermsRequest FromJson(string data)
  {
    return JsonConvert.DeserializeObject<AcceptDevTermsRequest>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
