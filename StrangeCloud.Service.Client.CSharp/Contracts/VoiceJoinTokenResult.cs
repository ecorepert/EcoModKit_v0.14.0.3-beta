...
// Type: StrangeCloud.Service.Client.Contracts.VoiceJoinTokenResult
...
/// <summary>Response for channel join request</summary>
[GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
public class VoiceJoinTokenResult : VoiceTokenResult
{
  ...
  public static VoiceJoinTokenResult FromJson(string data)
  {
    return JsonConvert.DeserializeObject<VoiceJoinTokenResult>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
