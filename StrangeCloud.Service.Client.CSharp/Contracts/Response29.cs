...
// Type: StrangeCloud.Service.Client.Contracts.Response29
...
public class Response29
{
  ...
  {
    return JsonConvert.DeserializeObject<Response29>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
