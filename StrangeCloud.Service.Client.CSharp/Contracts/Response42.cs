...
// Type: StrangeCloud.Service.Client.Contracts.Response42
...
public class Response42
{
  ...
  {
    return JsonConvert.DeserializeObject<Response42>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
