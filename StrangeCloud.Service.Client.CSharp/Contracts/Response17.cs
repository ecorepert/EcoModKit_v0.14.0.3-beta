...
// Type: StrangeCloud.Service.Client.Contracts.Response17
...
public class Response17
{
  ...
  {
    return JsonConvert.DeserializeObject<Response17>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
