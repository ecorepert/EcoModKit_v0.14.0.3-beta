...
// Type: StrangeCloud.Service.Client.Contracts.StreamInfo
...
public class StreamInfo
{
  ...
  {
    return JsonConvert.DeserializeObject<StreamInfo>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
