...
// Type: StrangeCloud.Service.Client.Contracts.IVoiceClient
...
{
  /// <summary>Generate the Vivox login auth token.</summary>
  /// <exception cref="T:StrangeCloud.Service.Client.Contracts.StrangeApiException">A server side error occurred.</exception>
  Task<VoiceLoginTokenResult> VivoxLoginTokenAsync(string vivoxId, string api_version);

  /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
  /// <summary>Generate the Vivox login auth token.</summary>
  /// <exception cref="T:StrangeCloud.Service.Client.Contracts.StrangeApiException">A server side error occurred.</exception>
  Task<VoiceLoginTokenResult> VivoxLoginTokenAsync(
    string vivoxId,
    string api_version,
    CancellationToken cancellationToken);

  /// <summary>Join the given Vivox channel by channel name.</summary>
  /// <exception cref="T:StrangeCloud.Service.Client.Contracts.StrangeApiException">A server side error occurred.</exception>
  Task<VoiceJoinTokenResult> VivoxJoinChannelTokenAsync(
    string vivoxId,
    string channelName,
    string api_version);
