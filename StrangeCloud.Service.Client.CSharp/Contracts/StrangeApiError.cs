...
// Type: StrangeCloud.Service.Client.Contracts.StrangeApiError
...
/// <summary>
/// Common result model for all Strange cloud api responses.
/// </summary>
[GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
public class StrangeApiError
{
  ...
  public static StrangeApiError FromJson(string data)
  {
    return JsonConvert.DeserializeObject<StrangeApiError>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
