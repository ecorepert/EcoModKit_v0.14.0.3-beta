...
// Type: StrangeCloud.Service.Client.Contracts.Response59
...
public class Response59
{
  ...
  {
    return JsonConvert.DeserializeObject<Response59>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
