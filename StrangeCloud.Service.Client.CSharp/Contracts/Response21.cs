...
// Type: StrangeCloud.Service.Client.Contracts.Response21
...
public class Response21
{
  ...
  {
    return JsonConvert.DeserializeObject<Response21>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
