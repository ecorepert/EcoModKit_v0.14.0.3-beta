...
// Type: StrangeCloud.Service.Client.Contracts.ErrorDetail
...
public class ErrorDetail
{
  ...
  {
    return JsonConvert.DeserializeObject<ErrorDetail>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
