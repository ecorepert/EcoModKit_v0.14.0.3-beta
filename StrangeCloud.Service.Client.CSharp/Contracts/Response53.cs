...
// Type: StrangeCloud.Service.Client.Contracts.Response53
...
public class Response53
{
  ...
  {
    return JsonConvert.DeserializeObject<Response53>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
