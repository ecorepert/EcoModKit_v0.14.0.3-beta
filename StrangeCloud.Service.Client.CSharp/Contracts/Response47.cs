...
// Type: StrangeCloud.Service.Client.Contracts.Response47
...
public class Response47
{
  ...
  {
    return JsonConvert.DeserializeObject<Response47>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
