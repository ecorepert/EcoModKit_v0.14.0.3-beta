...
// Type: StrangeCloud.Service.Client.Contracts.Response31
...
public class Response31
{
  ...
  {
    return JsonConvert.DeserializeObject<Response31>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
