...
// Type: StrangeCloud.Service.Client.Contracts.Response79
...
public class Response79
{
  ...
  {
    return JsonConvert.DeserializeObject<Response79>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
