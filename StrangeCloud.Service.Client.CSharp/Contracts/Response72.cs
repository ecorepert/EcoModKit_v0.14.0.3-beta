...
// Type: StrangeCloud.Service.Client.Contracts.Response72
...
public class Response72
{
  ...
  {
    return JsonConvert.DeserializeObject<Response72>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
