...
// Type: StrangeCloud.Service.Client.Contracts.AdminChangePassword
...
public class AdminChangePassword
{
  ...
  public static AdminChangePassword FromJson(string data)
  {
    return JsonConvert.DeserializeObject<AdminChangePassword>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
