...
// Type: StrangeCloud.Service.Client.Contracts.Response26
...
public class Response26
{
  ...
  {
    return JsonConvert.DeserializeObject<Response26>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
