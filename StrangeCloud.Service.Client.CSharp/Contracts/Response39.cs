...
// Type: StrangeCloud.Service.Client.Contracts.Response39
...
public class Response39
{
  ...
  {
    return JsonConvert.DeserializeObject<Response39>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
