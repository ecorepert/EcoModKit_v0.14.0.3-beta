...
// Type: StrangeCloud.Service.Client.Contracts.MarketplaceItem
...
public class MarketplaceItem
{
  ...
  [JsonProperty("achievementRequired")]
  public string AchievementRequired { get; set; }

  [JsonProperty("twitchDropID")]
  public string TwitchDropID { get; set; }
  ...
  [JsonProperty("isVoidStorage")]
  public bool? IsVoidStorage { get; set; }
  ...
  public static MarketplaceItem FromJson(string data)
  {
    return JsonConvert.DeserializeObject<MarketplaceItem>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
