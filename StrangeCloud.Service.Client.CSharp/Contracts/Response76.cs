...
// Type: StrangeCloud.Service.Client.Contracts.Response76
...
public class Response76
{
  ...
  {
    return JsonConvert.DeserializeObject<Response76>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
