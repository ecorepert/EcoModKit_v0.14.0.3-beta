...
// Type: StrangeCloud.Service.Client.Contracts.Response60
...
public class Response60
{
  ...
  {
    return JsonConvert.DeserializeObject<Response60>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
