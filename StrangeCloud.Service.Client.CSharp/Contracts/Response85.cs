...
// Type: StrangeCloud.Service.Client.Contracts.Response85
...
public class Response85
{
  ...
  {
    return JsonConvert.DeserializeObject<Response85>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
