...
// Type: StrangeCloud.Service.Client.Contracts.UserToKick
...
public class UserToKick
{
  ...
  public static UserToKick FromJson(string data)
  {
    return JsonConvert.DeserializeObject<UserToKick>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
