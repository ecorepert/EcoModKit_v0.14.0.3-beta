...
// Type: StrangeCloud.Service.Client.Contracts.Response65
...
public class Response65
{
  ...
  {
    return JsonConvert.DeserializeObject<Response65>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
