...
// Type: StrangeCloud.Service.Client.Contracts.Response57
...
public class Response57
{
  ...
  {
    return JsonConvert.DeserializeObject<Response57>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
