...
// Type: StrangeCloud.Service.Client.Contracts.Response4
...
public class Response4
{
  ...
  {
    return JsonConvert.DeserializeObject<Response4>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
