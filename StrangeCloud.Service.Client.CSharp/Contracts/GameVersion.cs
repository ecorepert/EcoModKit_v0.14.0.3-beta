...
// Type: StrangeCloud.Service.Client.Contracts.GameVersion
...
public class GameVersion
{
  ...
  public static GameVersion FromJson(string data)
  {
    return JsonConvert.DeserializeObject<GameVersion>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
