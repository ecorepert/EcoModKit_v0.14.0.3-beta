...
// Type: StrangeCloud.Service.Client.Contracts.Response54
...
public class Response54
{
  ...
  {
    return JsonConvert.DeserializeObject<Response54>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
