...
// Type: StrangeCloud.Service.Client.Contracts.Response84
...
public class Response84
{
  ...
  {
    return JsonConvert.DeserializeObject<Response84>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
