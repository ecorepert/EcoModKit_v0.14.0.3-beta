...
// Type: StrangeCloud.Service.Client.Contracts.Response55
...
public class Response55
{
  ...
  {
    return JsonConvert.DeserializeObject<Response55>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
