...
// Type: StrangeCloud.Service.Client.Contracts.Response68
...
public class Response68
{
  ...
  {
    return JsonConvert.DeserializeObject<Response68>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
