...
// Type: StrangeCloud.Service.Client.Contracts.Response81
...
public class Response81
{
  ...
  {
    return JsonConvert.DeserializeObject<Response81>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
