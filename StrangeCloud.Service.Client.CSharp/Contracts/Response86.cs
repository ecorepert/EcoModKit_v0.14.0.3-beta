...
// Type: StrangeCloud.Service.Client.Contracts.Response86
...
public class Response86
{
  ...
  {
    return JsonConvert.DeserializeObject<Response86>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
