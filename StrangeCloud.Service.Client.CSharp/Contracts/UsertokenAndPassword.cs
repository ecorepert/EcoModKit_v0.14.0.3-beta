...
// Type: StrangeCloud.Service.Client.Contracts.UsertokenAndPassword
...
public class UsertokenAndPassword
{
  [JsonProperty("token")]
  ...
  public static UsertokenAndPassword FromJson(string data)
  {
    return JsonConvert.DeserializeObject<UsertokenAndPassword>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
