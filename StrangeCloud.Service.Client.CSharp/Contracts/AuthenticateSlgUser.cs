...
// Type: StrangeCloud.Service.Client.Contracts.AuthenticateSlgUser
...
public class AuthenticateSlgUser
{
  ...
  public static AuthenticateSlgUser FromJson(string data)
  {
    return JsonConvert.DeserializeObject<AuthenticateSlgUser>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
