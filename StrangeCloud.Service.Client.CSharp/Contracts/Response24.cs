...
// Type: StrangeCloud.Service.Client.Contracts.Response24
...
public class Response24
{
  ...
  {
    return JsonConvert.DeserializeObject<Response24>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
