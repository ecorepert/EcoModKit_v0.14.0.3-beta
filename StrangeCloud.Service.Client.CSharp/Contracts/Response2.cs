...
// Type: StrangeCloud.Service.Client.Contracts.Response2
...
public class Response2
{
  ...
  {
    return JsonConvert.DeserializeObject<Response2>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
