...
// Type: StrangeCloud.Service.Client.Contracts.Response28
...
public class Response28
{
  ...
  {
    return JsonConvert.DeserializeObject<Response28>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
