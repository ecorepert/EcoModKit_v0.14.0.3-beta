...
// Type: StrangeCloud.Service.Client.Contracts.Response16
...
public class Response16
{
  ...
  {
    return JsonConvert.DeserializeObject<Response16>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
