...
// Type: StrangeCloud.Service.Client.Contracts.Response61
...
public class Response61
{
  ...
  {
    return JsonConvert.DeserializeObject<Response61>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
