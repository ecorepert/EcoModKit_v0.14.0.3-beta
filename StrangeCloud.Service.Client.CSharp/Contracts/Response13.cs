...
// Type: StrangeCloud.Service.Client.Contracts.Response13
...
public class Response13
{
  ...
  {
    return JsonConvert.DeserializeObject<Response13>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
