...
// Type: StrangeCloud.Service.Client.Contracts.Response27
...
public class Response27
{
  ...
  {
    return JsonConvert.DeserializeObject<Response27>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
