...
// Type: StrangeCloud.Service.Client.Contracts.Response34
...
public class Response34
{
  ...
  {
    return JsonConvert.DeserializeObject<Response34>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
