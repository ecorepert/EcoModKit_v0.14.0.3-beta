...
// Type: StrangeCloud.Service.Client.Contracts.Response78
...
public class Response78
{
  ...
  {
    return JsonConvert.DeserializeObject<Response78>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
