...
// Type: StrangeCloud.Service.Client.Contracts.Response51
...
public class Response51
{
  ...
  {
    return JsonConvert.DeserializeObject<Response51>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
