...
// Type: StrangeCloud.Service.Client.Contracts.Response12
...
public class Response12
{
  ...
  {
    return JsonConvert.DeserializeObject<Response12>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
