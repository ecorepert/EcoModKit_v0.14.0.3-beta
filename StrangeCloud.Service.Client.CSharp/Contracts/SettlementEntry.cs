...
// Type: StrangeCloud.Service.Client.Contracts.SettlementEntry
...
public class SettlementEntry
{
  ...
  [JsonProperty("activeCitizens")]
  public string ActiveCitizens { get; set; }

  [JsonProperty("citizenGuids")]
  public Collection<Guid> CitizenGuids { get; set; } = new Collection<Guid>();
  ...
  public static SettlementEntry FromJson(string data)
  {
    return JsonConvert.DeserializeObject<SettlementEntry>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
