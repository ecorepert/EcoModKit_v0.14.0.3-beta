...
// Type: StrangeCloud.Service.Client.Contracts.Response45
...
public class Response45
{
  ...
  {
    return JsonConvert.DeserializeObject<Response45>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
