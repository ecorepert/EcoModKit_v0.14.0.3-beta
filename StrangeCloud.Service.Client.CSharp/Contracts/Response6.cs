...
// Type: StrangeCloud.Service.Client.Contracts.Response6
...
public class Response6
{
  ...
  {
    return JsonConvert.DeserializeObject<Response6>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
