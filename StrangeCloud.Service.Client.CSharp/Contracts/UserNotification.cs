...
// Type: StrangeCloud.Service.Client.Contracts.UserNotification
...
public class UserNotification
{
  ...
  {
    return JsonConvert.DeserializeObject<UserNotification>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
