...
// Type: StrangeCloud.Service.Client.Contracts.Response
...
public class Response
{
  ...
  {
    return JsonConvert.DeserializeObject<Response>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
