...
// Type: StrangeCloud.Service.Client.Contracts.Response58
...
public class Response58
{
  ...
  {
    return JsonConvert.DeserializeObject<Response58>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
