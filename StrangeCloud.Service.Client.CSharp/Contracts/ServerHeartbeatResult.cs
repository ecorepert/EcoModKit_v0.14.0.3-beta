...
// Type: StrangeCloud.Service.Client.Contracts.ServerHeartbeatResult
...
public class ServerHeartbeatResult
{
  [JsonProperty("result")]
  public StrangeWorldRegistrationResult? Result { get; set; }

  [JsonProperty("usersToKick")]
  public Collection<UserToKick> UsersToKick { get; set; }

  [JsonProperty("streamInfo")]
  public Collection<StrangeCloud.Service.Client.Contracts.StreamInfo> StreamInfo { get; set; }
  ...
  public static ServerHeartbeatResult FromJson(string data)
  {
    return JsonConvert.DeserializeObject<ServerHeartbeatResult>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
