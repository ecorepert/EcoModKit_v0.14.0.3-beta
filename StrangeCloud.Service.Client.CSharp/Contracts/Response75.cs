...
// Type: StrangeCloud.Service.Client.Contracts.Response75
...
public class Response75
{
  ...
  {
    return JsonConvert.DeserializeObject<Response75>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
