...
// Type: StrangeCloud.Service.Client.Contracts.Response77
...
public class Response77
{
  ...
  {
    return JsonConvert.DeserializeObject<Response77>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
