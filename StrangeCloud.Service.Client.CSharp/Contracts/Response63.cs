...
// Type: StrangeCloud.Service.Client.Contracts.Response63
...
public class Response63
{
  ...
  {
    return JsonConvert.DeserializeObject<Response63>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
