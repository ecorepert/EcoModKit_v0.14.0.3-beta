...
// Type: StrangeCloud.Service.Client.Contracts.Response56
...
public class Response56
{
  ...
  {
    return JsonConvert.DeserializeObject<Response56>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
