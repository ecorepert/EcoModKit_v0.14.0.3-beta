...
// Type: StrangeCloud.Service.Client.Contracts.StrangeWorldRegistrationResult
...
public enum StrangeWorldRegistrationResult
{
  Success = 200, // 0x000000C8
  WorldNotOwnedByUser = 501, // 0x000001F5
}
