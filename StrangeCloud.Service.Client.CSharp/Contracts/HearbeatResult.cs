...
// Type: StrangeCloud.Service.Client.Contracts.HearbeatResult
...
public class HearbeatResult
{
  ...
  public static HearbeatResult FromJson(string data)
  {
    return JsonConvert.DeserializeObject<HearbeatResult>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
