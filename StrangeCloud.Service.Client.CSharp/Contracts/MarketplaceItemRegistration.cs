...
// Type: StrangeCloud.Service.Client.Contracts.MarketplaceItemRegistration
...
public class MarketplaceItemRegistration
{
  [JsonProperty("name")]
  ...
  public static MarketplaceItemRegistration FromJson(string data)
  {
    return JsonConvert.DeserializeObject<MarketplaceItemRegistration>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
