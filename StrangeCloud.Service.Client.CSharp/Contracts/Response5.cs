...
// Type: StrangeCloud.Service.Client.Contracts.Response5
...
public class Response5
{
  ...
  {
    return JsonConvert.DeserializeObject<Response5>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
