...
// Type: StrangeCloud.Service.Client.Contracts.Response18
...
public class Response18
{
  ...
  {
    return JsonConvert.DeserializeObject<Response18>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
