...
// Type: StrangeCloud.Service.Client.Contracts.Response46
...
public class Response46
{
  ...
  {
    return JsonConvert.DeserializeObject<Response46>(data, NSwagConfig.CreateCustomJsonSerializerSettings(new JsonSerializerSettings()));
  }
}
